        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Габдулла Тукай (1886–1913) — иң бөек татар шагыйре, милли әдәбиятның классигы. Кыска гомере дәвамында ул татар халкының рухына әверелгән йөзләрчә шигырь, поэма һәм әкиятләр иҗат итте.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Аның туган як, табигать һәм хыяллар турындагы шигырьләре йөз елдан артык яши. Платформабыз мәктәп укучыларына һәм үсмерләргә бу гаҗәеп дөньяны ачарга ярдәм итә — уеннар, иҗат һәм тере сүз аша.
            </p>
          </div>
        </div>
      </div>
