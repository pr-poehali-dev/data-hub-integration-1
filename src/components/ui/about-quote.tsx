        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Габдулла Тукай (1886–1913) — величайший татарский поэт, классик национальной литературы. За свою короткую жизнь он создал сотни стихов, поэм и сказок, ставших душой татарского народа.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Его стихи о родине, природе и мечтах живут уже более ста лет. Наша платформа помогает школьникам и подросткам открыть для себя этот удивительный мир — через игры, творчество и живое слово.
            </p>
          </div>
        </div>
      </div>
